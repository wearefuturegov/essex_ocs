...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = ENV["COMFORTABLE_MEXICAN_SOFA_USERNAME"]
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = ENV["COMFORTABLE_MEXICAN_SOFA_PASSWORD"]
